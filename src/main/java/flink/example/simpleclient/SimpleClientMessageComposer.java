...
public class SimpleClientMessageComposer {
	...
	public String getResponseString(String protocolVersion, int serverMessageType, String seqNum, boolean isSuccess,
		...
		if (serverMessage == null)
			serverMessage = "";
		return protocolVersion + ";" + serverMessageType + ";" + seqNum + ";" + successStr + ";" + serverMessage
				+ ";\n";
	}
	...
	public String getNormalUploadSuccess(String clientMessageSeqNrStr, int processedReportCount,
		...
		return getResponseString(PROTOCOL_VERSION, MessageTypes.NORMAL_UPLOAD.ordinal(), clientMessageSeqNrStr, true,
	...
	public byte[] getNormalUploadExpirationFailure(String clientMessageSeqNrStr) {
		...
		// 0.1;1;0000;0;1\n
		return getResponseString(PROTOCOL_VERSION, MessageTypes.NORMAL_UPLOAD.ordinal(), clientMessageSeqNrStr, false,
	...
	public byte[] getResponsePairSucceed(String clientMessageSeqNrStr, boolean isSuccess, String nativeId) {
		return getResponseString(PROTOCOL_VERSION, MessageTypes.PAIRING.ordinal(), clientMessageSeqNrStr, isSuccess,
				nativeId).getBytes();
	}
	...
	public byte[] getExpirationCheckAnswer(boolean isExpired, int clientMessageSeqNrStr) {
		...
		return getResponseString(PROTOCOL_VERSION, MessageTypes.EXPIRATION_CHECK.ordinal(), clientMessageSeqNrStr + "",
