...
public class SimpleClientNativeMessageParser {
	...
	public ParseMessageResult parseNativeMessage(Location value) throws InvalidNativeMessageException {
		try {
			...
			case CONFIG:
			default: {
				throw new InvalidNativeMessageException("Invalid message type: '" + messageTypeStr + "'.");
			}
			}
	...
	private Report messagePartToReport(String messagePart) throws InvalidNativeMessageException {
		...
		if (posSrc == -1)
			throw new InvalidNativeMessageException("Invalid position source, report: '" + messagePart + "'.");

		// position data may not be null or empty
		if (reportStrParts[1] == null || reportStrParts[1].isEmpty())
			throw new InvalidNativeMessageException("Invalid position data, report: '" + messagePart + "'.");
	...
	private ExtendedData messagePartToExtendedData(String messagePart) throws InvalidNativeMessageException {
		/*
